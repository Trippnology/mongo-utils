...
(function() {
  ...
  describe("makeFindCommand", function() {
    it("works with a sole query object", function() {
      ...
      expected = "db.nodes.find({\"ownerId\":\"6ac4f70f-fe05-4a7d-bba8-99d6fbe62261\"})";
    ...
    it("works when options object has 'sort' field", function() {
      ...
      expected = "db.nodes.find({\"ownerId\":\"6ac4f70f-fe05-4a7d-bba8-99d6fbe62261\"}).sort({\"addedAt\":1})";
      return assert.equal(generated, expected);
    });
    return it("works when options object has 'fields' field", function() {
      ...
      expected = "db.nodes.find({\"ownerId\":\"6ac4f70f-fe05-4a7d-bba8-99d6fbe62261\"},{\"value\":1,\"addedAt\":1,\"changedAt\":1})";
      return assert.equal(generated, expected);
    });
  });
...
/*
//@ sourceMappingURL=makeFindCommand.map
*/
